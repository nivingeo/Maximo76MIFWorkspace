...
public class ServRecTransExtSet extends ServRecTransSet implements ServRecTransExtSetRemote {

	final private String APPLOGGER = "maximo.application.LABOR";
	private MXLogger log;

	public ServRecTransExtSet(MboServerInterface mboServerInterface0) throws MXException, RemoteException {
